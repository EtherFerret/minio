...
// returns ErrNone if the signature matches.
func doesPresignedSignatureMatch(ctx context.Context, hashedPayload string, r *http.Request, region string) APIErrorCode {
	// Copy request
	req := *r
...
func doesSignatureMatch(ctx context.Context, hashedPayload string, r *http.Request, region string) APIErrorCode {
	// Copy request.
	req := *r
